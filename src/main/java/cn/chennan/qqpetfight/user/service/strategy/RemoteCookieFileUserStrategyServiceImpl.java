 ...
 */
@Service
public class RemoteCookieFileUserStrategyServiceImpl implements IUserStrategyService {
    private static final Logger logger = LoggerFactory.getLogger(RemoteCookieFileUserStrategyServiceImpl.class);
